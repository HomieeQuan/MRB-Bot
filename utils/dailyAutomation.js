...
class DailyAutomation {
                        ...
                        try {
                            ...
                            if (!eligibility.nextRank) {
                                ...
                                notificationFields.push({
                                    ...
                                    value: 'Continue your excellent service as a leader in the MRB team!',
                                    inline: false
                                });
                            ...
                            const notification = new EmbedBuilder()
                                ...
                                .setFooter({ 
                                    text: 'Keep up the great work! Submit events to continue your MRB career progression.' 
                                })
                                .setTimestamp();
    ...
    static async sendHRDailySummary(client, automationData) {
        try {
            ...
            // Get all members with HR roles (Commanding Officer and above)
            const hrRoles = [
                'Commanding Officer',
    ...
    static async getAutomationStats() {
        try {
            // Get automation logs from last 14 days
