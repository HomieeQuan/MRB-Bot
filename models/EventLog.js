// models/EventLog.js - MRB event logging with multiple screenshot support
...
const eventLogSchema = new mongoose.Schema({
    ...
    streakBonusApplied: {
        type: Number,
        default: 0  // Percentage bonus applied (0, 5, 10, 15)
    },
...
// NEW: Streak bonus tracking
eventLogSchema.index({ streakBonusApplied: 1, submittedAt: -1 }, { 
    name: 'streak_bonus_idx',
    background: true,
    sparse: true
});
